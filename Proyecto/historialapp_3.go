...
const ID = 2
const host = "localhost:8005"
const protocol = "tcp"
const webServerPort = ":5002"

var dirs = []string{"localhost:8003", "localhost:8004"}
var localBlockchain Blockchain
var nodosBlockchain []Blockchain

type Entrada struct {
	año           int      `json:"año"`
	atencion      Atencion `json:"atencion"`
...
//type Persona struct{
//	annios		  []Año `json:"annios"`
//}

type HistoriaClinica struct {
	Nombre   string 	`json:"nombre" binding:"exists"`
	Entradas []Entrada 	`json:"entradas" binding:"exists"`
...
func GenesisBlock() Block {
	return CreateBlock(Block{IsGenesis: true}, HistoriaClinica{})
}
...
func receive(conn net.Conn, bl chan Command) {
	alldirs := []string{"localhost:8003", "localhost:8004", "localhost:8005"}
